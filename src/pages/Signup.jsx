     ...
     <div >
        <form className='p-4 flex flex-col'>
             ...
             <div className=' flex justify-between'>
                  <button className='bg-white border-2 shadow-lg hover:shadow rounded-xl px-2  py-2 flex flex-col items-center '><AiFillFacebook className='mr-2 h-10 w-10'/>log in with Facebook</button>

                  <button className='bg-white border-2  shadow-md hover:shadow rounded-xl px-2  py-2 flex flex-col items-center' ><FcGoogle className='mr-2 h-10 w-10'/>log in  with Google</button>
                 ...
                 <div className='flex flex-col pt-4 space-y-4'>
                   ...
                   <input className='rounded-xl boder p-2 mr-2 ' type="number" placeholder='Phone number' required  />
